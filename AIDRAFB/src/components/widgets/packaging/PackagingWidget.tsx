...
import { Check, Send, Printer, ClipboardList, Play, ChevronRight, Info, Package, AlertTriangle, CheckCircle, Percent } from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const SheetDialog = ({ job, isOpen, onOpenChange }: { job: Job | null, isOpen: boolean, onOpenChange: (open: boolean) => void }) => {
    ...
    const documentTitle = isExternal ? 'Ordine di Conto Lavoro / DDT' : 'Scheda di Lavorazione Packaging';
...
export default function PackagingWidget() {
  ...
  return (
    ...
    <CardHeader>
      <CardTitle>Reparto Packaging</CardTitle>
      <CardDescription>Assegna e traccia i lotti di packaging per spedizione.</CardDescription>
