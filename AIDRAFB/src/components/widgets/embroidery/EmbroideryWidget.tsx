...
import { Check, Send, Printer, ClipboardList, Play, ChevronRight, Info, PencilRuler, AlertTriangle, CheckCircle, Percent, Package } from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const CURRENT_STAGE = "Embroidery";
...
const SheetDialog = ({ job, isOpen, onOpenChange }: { job: Job | null, isOpen: boolean, onOpenChange: (open: boolean) => void }) => {
    ...
    const documentTitle = isExternal ? 'Ordine di Conto Lavoro / DDT' : 'Scheda di Lavorazione Ricamo';
...
export default function EmbroideryWidget() {
  ...
  return (
    ...
    <CardHeader>
      <CardTitle>Reparto Ricamo</CardTitle>
      <CardDescription>Assegna e traccia i lotti di ricamo per lavorazioni interne ed esterne.</CardDescription>
