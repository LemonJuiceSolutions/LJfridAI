...
import { Check, Send, Printer, ClipboardList, Play, ChevronRight, Info, Boxes, AlertTriangle, CheckCircle, Percent, Package } from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const SheetDialog = ({ job, isOpen, onOpenChange }: { job: Job | null, isOpen: boolean, onOpenChange: (open: boolean) => void }) => {
    ...
    const documentTitle = isExternal ? 'Ordine di Conto Lavoro / DDT' : 'Scheda di Lavorazione Magazzino';
...
export default function MagazzinoWidget() {
  ...
  return (
    ...
    <CardHeader>
      <CardTitle>Magazzino Prodotti Finiti</CardTitle>
      <CardDescription>Gestisci lo stoccaggio dei prodotti finiti pronti per la spedizione.</CardDescription>
      ...
      <Tabs defaultValue="assign">
          <TabsList className="grid w-full grid-cols-4">
              <TabsTrigger value="assign">
                  ...
                  Da Stoccare ({jobsToBeAssigned.length})
              </TabsTrigger>
              ...
              <TabsTrigger value="progress">
                  ...
                  In Stoccaggio ({jobsInProgress.length})
              </TabsTrigger>
              <TabsTrigger value="completed">
                  <Check className="h-4 w-4 mr-2"/>
                  Stoccati / Spediti ({jobsCompleted.length})
              </TabsTrigger>
          </TabsList>
