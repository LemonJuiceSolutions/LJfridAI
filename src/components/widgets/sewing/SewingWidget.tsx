...
import { Check, Send, Printer, ClipboardList, Play, ChevronRight, Info, Shirt, AlertTriangle, CheckCircle, Percent, Package } from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const SheetDialog = ({ job, isOpen, onOpenChange }: { job: Job | null, isOpen: boolean, onOpenChange: (open: boolean) => void }) => {
    ...
    const documentTitle = isExternal ? 'Ordine di Conto Lavoro / DDT' : 'Scheda di Lavorazione Confezione';
...
export default function SewingWidget() {
  ...
  return (
    ...
    <CardHeader>
      <CardTitle>Reparto Confezione</CardTitle>
      <CardDescription>Assegna e traccia i lotti di confezionamento per lavorazioni interne ed esterne.</CardDescription>
