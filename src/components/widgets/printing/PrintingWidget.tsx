...
import { Check, Send, Printer, ClipboardList, Play, ChevronRight, Info, Brush, AlertTriangle, CheckCircle, Percent, Package } from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const SheetDialog = ({ job, isOpen, onOpenChange }: { job: Job | null, isOpen: boolean, onOpenChange: (open: boolean) => void }) => {
    ...
    const documentTitle = isExternal ? 'Ordine di Conto Lavoro / DDT' : 'Scheda di Lavorazione Stampa';
...
export default function PrintingWidget() {
  ...
  return (
    ...
    <CardHeader>
      <CardTitle>Reparto Stampa</CardTitle>
      <CardDescription>Assegna e traccia i lotti di stampa per lavorazioni interne ed esterne.</CardDescription>
