...
import { Check, Send, Printer, ClipboardList, Play, ChevronRight, Info, Droplets, AlertTriangle, CheckCircle, Percent, Package } from 'lucide-react';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
const CURRENT_STAGE = "Lavanderia";
...
const SheetDialog = ({ job, isOpen, onOpenChange }: { job: Job | null, isOpen: boolean, onOpenChange: (open: boolean) => void }) => {
    ...
    const documentTitle = isExternal ? 'Ordine di Conto Lavoro / DDT' : 'Scheda di Lavorazione Lavanderia';
...
export default function LavanderiaWidget() {
  ...
  return (
    ...
    <CardHeader>
      <CardTitle>Reparto Lavanderia</CardTitle>
      <CardDescription>Assegna e traccia i lotti di lavaggio per lavorazioni interne ed esterne.</CardDescription>
