                                        ...
                                        {iconOptions.map(iconKey => {
                                            ...
                                            return (
                                                <Button
                                                    ...
                                                    size="icon"
                                                    onClick={() => setNodeIcon(iconKey as string)}
                                                >
                                                        ...
                                                        <ReactMarkdown
                                                            components={{
                                                                code({ node, className, children, ...props }: any) {
                                                                    ...
                                                                    // inline is sometimes in props for older versions, or passed as a separate arg
                                                                    const isInline = props.inline || (node as any)?.inline;
