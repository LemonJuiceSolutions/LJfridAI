...
export async function detaiFlow(input: DetaiInput): Promise<DetaiOutput> {
  ...
  const systemMessage = {
    ...
    content: [{ text: `Sei detAI, un assistente IA esperto e proattivo. Il tuo compito è rispondere in modo utile e, soprattutto, basare le tue risposte sulla conoscenza contenuta in un database di alberi decisionali.
