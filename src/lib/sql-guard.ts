...
export const BLOCKED_KEYWORDS_RE =
    /\b(DROP|TRUNCATE|ALTER|CREATE|EXEC|EXECUTE|xp_\w+|sp_executesql|xp_cmdshell|sp_|OPENROWSET|OPENQUERY|OPENDATASOURCE|BULK\s+INSERT|BACKUP|RESTORE|SHUTDOWN|RECONFIGURE|GRANT|REVOKE|DENY|INTO\s+OUTFILE|DBCC|WAITFOR|USE\s+\w)\b/i;
