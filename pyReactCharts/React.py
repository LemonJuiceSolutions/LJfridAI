...
data = [
    {"mese": "Gen", "Budget": 100, "Fatturato": 80, "Prodotto": 60},
    {"mese": "Feb", "Budget": 120, "Fatturato": 90, "Prodotto": 70},
    {"mese": "Mar", "Budget": 130, "Fatturato": 110, "Prodotto": 85},
]
...
const data: ChartData[] = {json.dumps(data, ensure_ascii=False)};
...
Path("MyChart.tsx").write_text(tsx, encoding="utf-8")
print("Creato MyChart.tsx")
print("Per visualizzare il grafico, esegui: npm run dev")
